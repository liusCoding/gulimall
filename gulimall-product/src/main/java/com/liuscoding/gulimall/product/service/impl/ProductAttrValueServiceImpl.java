...
import com.liuscoding.gulimall.product.dao.ProductAttrValueDao;
...
public class ProductAttrValueServiceImpl extends ServiceImpl<ProductAttrValueDao, ProductAttrValueEntity> implements ProductAttrValueService {
    ...
    @Override
    public void saveProductAttr(List<ProductAttrValueEntity> productAttrList) {
        this.saveBatch(productAttrList);
    }
